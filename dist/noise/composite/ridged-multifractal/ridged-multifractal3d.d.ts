 ...
 */
export type RidgedMultifractalNoise3D = (x: number, y: number, z: number, initialWeight?: number, octaves?: number, lacunarity?: number, gain?: number, offset?: number, frequency?: number, amplitude?: number) => number;
/**
 ...
 */
export declare function ridgedMultifractal3D(noise3D: Noise3D): RidgedMultifractalNoise3D;
